...
const checks = [
  ...
  ['src/layouts/StudioLayout.astro', ['原力 Studio', '只读控制面', 'Studio不是第七个真源', '今日', '雷达', '研究', '生产', '发布', '学习', '系统']],
  ['src/data/studio.ts', ['MG-D2-ai-distillation-v1', "actionStatus: 'NOT_RUN'", "outcomeStatus: 'NOT_RUN'", 'yuanli-strategy-soul/issues/457', 'yuanli-brain/issues/2', 'yuanli-content-engine-os/issues/35', 'yuanli-pmo/issues/23']],
